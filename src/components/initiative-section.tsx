...
export function InitiativeSection() {
  return (
    <section className="bg-[#241512] py-10 text-white sm:py-12">
      <div className="mx-auto grid max-w-7xl gap-6 px-4 sm:px-6 lg:grid-cols-[1fr_0.72fr] lg:items-center lg:px-8">
        ...
        <div id="sumar-comercio" className="rounded-2xl border border-white/15 bg-white/[0.06] p-5">
          <h3 className="font-display text-xl font-bold">Tu negocio todavia no esta aqui?</h3>
          ...
          {INCLUSION_WHATSAPP ? (
            <a
              ...
              className="md-tonal-button mt-5 px-5 text-sm focus:ring-offset-[#241512]"
            >
              Solicitar inclusion
            </a>
          ) : (
